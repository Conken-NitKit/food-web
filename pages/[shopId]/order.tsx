          ...
          {Object.values(OrderContents).map((content) => {
            return (
              <li
                ...
                className="relative mb-[16px] pt-[18px] pb-[15px] pr-[85px] pl-[11px] w-full h-[94px] bg-navajowhite-a100 rounded-[13px]"
              >
                <div className="flex">
                  <div className="flex items-center text-center mt-[5px] mr-[6px] w-[64px] h-[48px] font-menu-card font-bold text-[48px]">
                    {content.product.ideogram}
                  </div>
                  <div className="w-full font-['Mulish'] text-[#121212]">
