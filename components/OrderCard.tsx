export const OrderCard = (): JSX.Element => {
  return (
    <div className="overflow-hidden rounded-[10px] md:rounded-[12px] lg:rounded-[15px] xl:rounded-[19px] 2xl:rounded-[23px] w-[419px] md:w-[503px] lg:w-[671px] xl:w-[838px] 2xl:w-[1006px] h-[131px] md:h-[157px] lg:h-[210px] xl:h-[262px] 2xl:h-[315px] shadow-2xl bg-primary-regular">
      <div className="text-primary-regular">
        ...
        <div className="flex mx-auto mt-[3.5%] w-[92%]">
