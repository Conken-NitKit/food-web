...
export const MenuCard = ({ content, isSold }: Props): JSX.Element => {
  return (
    <div className="overflow-hidden mt-[48px] 2xl:mt-[58px] ml-[38px] 2xl:ml-[46px] rounded-[19px] 2xl:rounded-[23px] w-[237px] 2xl:w-[284px] h-[247px] 2xl:h-[297px] shadow-menu-card cursor-pointer font-menu-card">
      <div
