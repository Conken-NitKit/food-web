export const HomeGuide = (): JSX.Element => {
  return (
    <div className="mx-auto mt-[14px] md:mt-[17px] lg:mt-[23px] xl:mt-[29px] 2xl:mt-[35px] w-[260px] md:w-[312px] lg:w-[415px] xl:w-[519px] 2xl:w-[623px] h-[121px] md:h-[145px] lg:h-[193px] xl:h-[242px] 2xl:h-[290px] text-primary-regular">
      <h1 className="text-[11px] md:text-[13px] lg:text-[18px] xl:text-[22px] 2xl:text-[27px] font-bold">使い方</h1>
      <ul className="overflow-scroll flex flex-wrap mt-[4.93%] h-[85%]">
        <li className="flex mb-[3.3%] w-[47.45%] h-[25%] even:ml-auto">
          ...
          <p className="overflow-scroll ml-[6.5%] text-[6px] md:text-[8px] lg:text-[10px] xl:text-[13px] 2xl:text-[15px] font-bold">
