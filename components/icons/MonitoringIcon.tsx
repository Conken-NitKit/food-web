...
export const MonitoringIcon: ({ isChoose }: IconProps) => JSX.Element = ({
  isChoose,
}) => {
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke={isChoose ? "url(#paint0_linear_28_1136)" : "white"}
        strokeWidth="2"
        strokeMiterlimit="10"
      />
      <path
        d="M21.1436 21.1431L28.0004 27.9999"
        stroke={isChoose ? "url(#paint1_linear_28_1136)" : "white"}
        strokeWidth="2"
        strokeMiterlimit="10"
        strokeLinecap="round"
      />
