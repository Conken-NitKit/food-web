...
export const ShiftIcon: ({ isChoose }: IconProps) => JSX.Element = ({
  isChoose,
}) => {
  return (
    <svg viewBox="0 0 36 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_12_175)">
        <path
          ...
          fill={isChoose ? "url(#paint0_linear_28_799)" : "white"}
        />
        <path
          ...
          fill={isChoose ? "url(#paint1_linear_28_799)" : "white"}
        />
        <path
          ...
          stroke={isChoose ? "url(#paint2_linear_28_799)" : "white"}
          strokeWidth="2"
          strokeLinecap="round"
