...
export const OrderIcon: ({ isChoose }: IconProps) => JSX.Element = ({
  isChoose,
}) => {
  return (
    <svg viewBox="0 0 36 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke={isChoose ? "url(#paint0_linear_12_300)" : "white"}
        strokeWidth="2"
      ...
      <path
        ...
        stroke={isChoose ? "url(#paint1_linear_12_300)" : "white"}
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M20.5301 14H29.3355M16.1274 9H29.3355H16.1274Z"
        stroke={isChoose ? "url(#paint2_linear_12_300)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
