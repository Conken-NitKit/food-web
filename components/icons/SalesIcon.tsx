...
export const SalesIcon: ({ isChoose }: IconProps) => JSX.Element = ({
  isChoose,
}) => {
  return (
    <svg viewBox="0 0 36 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke={isChoose ? "url(#paint0_linear_21_649)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
      ...
      <path
        ...
        stroke={isChoose ? "url(#paint1_linear_21_649)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        ...
        stroke={isChoose ? "url(#paint2_linear_21_649)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        ...
        stroke={isChoose ? "url(#paint3_linear_21_649)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
