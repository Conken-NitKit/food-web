...
export const HomeIcon = ({ chosen }: IconProps) => {
  const isChose = chosen === "home";
  ...
  return (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke={isChose ? "url(#paint0_linear_12_152)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
      ...
      <path
        ...
        stroke={isChose ? "url(#paint1_linear_12_152)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
