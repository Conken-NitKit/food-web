...
export const UserIcon: ({ isChoose }: IconProps) => JSX.Element = ({
  isChoose,
}) => {
  return (
    <svg viewBox="0 0 36 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke={isChoose ? "url(#paint0_linear_28_920)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
      ...
      <path
        ...
        stroke={isChoose ? "url(#paint1_linear_28_920)" : "white"}
        strokeWidth="2"
        strokeMiterlimit="10"
      />
      <path
        d="M10.6236 14.5H2.91895M6.77129 11V18V11Z"
        stroke={isChoose ? "url(#paint2_linear_28_920)" : "white"}
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
